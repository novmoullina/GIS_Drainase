                ...
                <script type="text/javascript">
                    var vectorLayer = new ol.layer.Vector({
                        source: new ol.source.Vector({
                            ...
                            url: '<?php echo base_url() ?>data/kering.json' //url ini digunakan untuk mengambil data banjir yang telah ada digitasi pointnya.
                        }),
                        style: new ol.style.Style({
                            image: new ol.style.Icon(({
                                ...
                                anchorYUnits: 'pixels',
                                src: '<?php echo base_url() ?>icon/kering.png' //merupakan tampilan gambar petunjuk location
                            }))
                        })
                    });
                    var map = new ol.Map({
