            ...
            <div class="d-none d-sm-block mb-5 pb-4">
                ...
                <center>
                    ...
                    <div style="display: grid; justify-content:center; grid-gap:8px; grid-template-columns:repeat(3,auto)">
                        ...
                        <a href="<?= site_url('home/tersumbat') ?>" class="btn btn-primary">Drainase Kering</a>
                ...
                <script type="text/javascript">
                    var vectorLayer = new ol.layer.Vector({
                        source: new ol.source.Vector({
                            ...
                            url: '<?php echo base_url() ?>data/greenhouse.json' //url ini digunakan untuk mengambil data banjir yang telah ada digitasi pointnya.
                        }),
                        style: new ol.style.Style({
                            image: new ol.style.Icon(({
                                ...
                                anchorYUnits: 'pixels',
                                src: '<?php echo base_url() ?>icon/home.png' //merupakan tampilan gambar petunjuk location
                            }))
                        })
                    });
                    var map = new ol.Map({
