                ...
                <div class="row">
                    <div class="col-lg-11">
                        <div class="hero__caption">
                            ...
                            <h1 data-animation="fadeInUp" data-delay=".5s">Peta</h1>
                ...
                <script type="text/javascript">
                    var vectorLayer = new ol.layer.Vector({
                        source: new ol.source.Vector({
                            ...
                            url: '<?php echo base_url() ?>data/drainase.json' //url ini digunakan untuk mengambil data banjir yang telah ada digitasi pointnya.
                        }),
                        style: new ol.style.Style({
                            image: new ol.style.Icon(({
                                ...
                                anchorYUnits: 'pixels',
                                src: '<?php echo base_url() ?>icon/placeholder.png' //merupakan tampilan gambar petunjuk location
                            }))
                        })
                    });
                    var vectorLayer2 = new ol.layer.Vector({
                        source: new ol.source.Vector({
                            format: new ol.format.GeoJSON(),
                            url: '<?php echo base_url() ?>data/jalan3.json' //url ini digunakan untuk mengambil data banjir yang telah ada digitasi pointnya.
                        }),
                    ...
                    var map = new ol.Map({
                        ...
                        layers: [
                            ...
                            }), vectorLayer, vectorLayer2 //digunakan untuk menampilkan hasil dari digitasi dan polygonnya
                        ],
                        view: new ol.View({
                            center: ol.proj.fromLonLat([101.44144583158257, 0.5647964024738169]), //untuk menentukan titik koordinat awal peta riau
                            zoom: 15 //bisa digunakan untuk menzoom sampai 10 kali
                        })
                    });
                </script>
                ...
                <script type="text/javascript">
                    ...
                    map.on('click', function(evt) {
                        ...
                        if (feature) { // untuk cek feature jalan atau tidak
                            ...
                            content += '<p>Perumahan : ' + feature.get('Nama_Perum') + '</p>';
                            content += '<p>Lebar(cm) : ' + feature.get('Lebar__m_') + '</p>';
                            content += '<p>Kedalaman(cm) : ' + feature.get('Kedalaman') + '</p>';
                            content += '<p>Arah Alir : ' + feature.get('Arah_Alir') + '</p>';
                            content += '<p>Kondisi : ' + feature.get('Kondisi') + '</p>';
